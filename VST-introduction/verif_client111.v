...
- admit. (*destruct H as [H1 [H2 [H31 | H32]]]; split; auto. destruct H31; subst; unfold nullval; unfold is_pointer_or_null; simpl; auto.
    destruct H32. auto. *)
- forward_call (sh, pa1, xx, (S n), original_freelist_pointer, gv). (* call alloc*)
    + destruct (eq_dec pa1 nullval) eqn:epa1; try (rewrite S_pred); entailer!.
    + admit. (*destruct H as [H1 [H2 [H3 H4]]]; split; auto. right; split; try rep_lia; auto.*)
