...
Module Info.
  ...
  Definition source_file := "nest2_modified_remove_a.c".
...
Definition f_get := {|
  ...
  fn_body :=
(Ssequence
  (Sset _i (Efield (Evar _p (Tstruct _b noattr)) _y1 tint))
...
Definition f_set := {|
  ...
  fn_temps := nil;
  fn_body :=
(Sassign (Efield (Evar _p (Tstruct _b noattr)) _y1 tint) (Etempvar _i tint))
|}.
...
(Ssequence
  (Ssequence
    (Scall None (Evar _set (Tfunction (tint :: nil) tvoid cc_default))
      ((Econst_int (Int.repr 42) tint) :: nil))
    (Ssequence
      (Ssequence
        (Scall (Some _t'1) (Evar _get (Tfunction nil tint cc_default)) nil)
...
(Composite _b Struct (Member_plain _y1 tint :: nil) noattr :: nil).
