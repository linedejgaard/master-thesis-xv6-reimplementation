...
Definition _newstack : ident := $"newstack".
Definition _pop : ident := $"pop".
Definition _pop_and_add : ident := $"pop_and_add".
Definition _push : ident := $"push".
Definition _push_increasing : ident := $"push_increasing".
Definition _s : ident := $"s".
Definition _st : ident := $"st".
Definition _stack : ident := $"stack".
Definition _t : ident := $"t".
Definition _triang : ident := $"triang".
