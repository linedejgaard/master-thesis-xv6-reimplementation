...
(** Stack 1: No helping, bag spec. Taken from https://gitlab.mpi-sws.org/iris/examples/-/blob/master/theories/concurrent_stacks/concurrent_stack1.v?ref_type=heads *)
...
(* API specification and helper functions *)
Section stacks.
