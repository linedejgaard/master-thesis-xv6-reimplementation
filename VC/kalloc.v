...
(Ssequence
  (Scall None
    (Evar _initlock (Tfunction
                      (Tcons (tptr (Tstruct _spinlock noattr))
  ...
  (Sloop
    (Ssequence
      (Sifthenelse (Ebinop Ole
        ...
        Sbreak)
      (Scall None
        (Evar _kfree (Tfunction (Tcons (tptr tvoid) Tnil) tvoid cc_default))
...
Definition f_kfree := {|
  ...
  fn_vars := nil;
  fn_temps := ((_r, (tptr (Tstruct _run noattr))) :: (_t'2, tint) ::
               (_t'1, tint) :: (_t'3, (tptr (Tstruct _run noattr))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
        ...
        (Sset _t'1
          (Ecast
            (Ebinop Olt (Ecast (Etempvar _pa (tptr tvoid)) (tptr tschar))
              (Evar _end (tarray tschar 0)) tint) tbool)))
    ...
    (Sifthenelse (Etempvar _t'2 tint)
      (Scall None
        (Evar _panic (Tfunction (Tcons (tptr tschar) Tnil) tvoid cc_default))
  ...
  (Ssequence
    (Scall None
      ...
      ((Etempvar _pa (tptr tvoid)) :: (Econst_int (Int.repr 1) tint) ::
      ...
      (Ssequence
        (Scall None
          (Evar _acquire (Tfunction
                           (Tcons (tptr (Tstruct _spinlock noattr)) Tnil)
                           tvoid cc_default))
          ((Eaddrof
             (Efield (Evar _kmem (Tstruct __595 noattr)) _lock
               (Tstruct _spinlock noattr)) (tptr (Tstruct _spinlock noattr))) ::
...
(Ssequence
  (Scall None
    (Evar _acquire (Tfunction (Tcons (tptr (Tstruct _spinlock noattr)) Tnil)
                     tvoid cc_default))
    ((Eaddrof
       (Efield (Evar _kmem (Tstruct __595 noattr)) _lock
         (Tstruct _spinlock noattr)) (tptr (Tstruct _spinlock noattr))) ::
...
((___compcert_va_int32,
 ...
 (_acquire,
   Gfun(External (EF_external "acquire"
                   (mksignature (AST.Tlong :: nil) AST.Tvoid cc_default))
     (Tcons (tptr (Tstruct _spinlock noattr)) Tnil) tvoid cc_default)) ::
 (_initlock,
   Gfun(External (EF_external "initlock"
                   (mksignature (AST.Tlong :: AST.Tlong :: nil) AST.Tvoid
                     cc_default))
     (Tcons (tptr (Tstruct _spinlock noattr)) (Tcons (tptr tschar) Tnil))
     tvoid cc_default)) ::
 (_release,
 ...
 (_memset,
   Gfun(External (EF_external "memset"
     ...
     cc_default)) :: (_end, Gvar v_end) :: (_kmem, Gvar v_kmem) ::
 (_kinit, Gfun(Internal f_kinit)) ::
 (_freerange, Gfun(Internal f_freerange)) ::
 (_kfree, Gfun(Internal f_kfree)) :: (_kalloc, Gfun(Internal f_kalloc)) ::
 nil).
